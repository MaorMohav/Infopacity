...
def Submit_Login(request):
    ...
    if user_type == 'Manager':
        ...
        return render(request, 'Login/ManagerHome.html', {'manager':manager})
        

    return HttpResponse("in build")

def Show_Manager_Personal_Update(request):
    return render(request,'ManagerPersonal/ManagerPersonal.html',{})
