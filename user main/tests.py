...
class Views_Test(TestCase):
    ...
    def test_Manager_is_exists(self):
        user = Manager(user_name = 'Ariel',password = '123456',password_conf='123456',email='Ariel@gmail.com',business_name='Infopacity',business_code='32168421')
        user.save()
    ...
    def test_Employee_is_exists(self):
        user = Employee(user_name = 'Maor',password = '123456',password_conf='123456',email='Maor@gmail.com',business_name='Infopacity',business_code='32168421')
        user.save()
    ...
    def test_Client_is_exists(self):
        user = Client(user_name = 'Sergey',password = '123456',password_conf='123456',email='Sergey@gmail.com')
        user.save()
