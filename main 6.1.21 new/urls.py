...
urlpatterns = [
    ...
    path('employee/update/b_code',views.BusinessUpdate,name="BUpdate"),
    ...
    path('EmployeeHome/search',views.EmployeeSearch,name = "EmployeeSearch"),
    path('ManagerHome/search',views.ManagerSearch,name = "ManagerSearch"),
